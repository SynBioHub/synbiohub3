...
class TestTwins(TestCase):
    def test_twins(self):
        ...
        compare_get_request("public/:collectionId/:displayId/:version/twins", headers = {"Accept": "text/plain"}, route_parameters = ["igem","BBa_B0034","1"], test_type = test_type, comparison_type="jsonlist", fields=["uri", "displayId", "version", "name", "description", "type"], key='uri')
