...
from test_functions import compare_get_request, compare_post_request, compare_get_request_json, compare_get_request_json_list
...
class TestAdmin(TestCase):
    ...
    def test_admin1(self):
        ...
        compare_get_request_json("/admin", headers = {"Accept":"text/plain"}, test_type = test_type, fields=["instanceName"])
