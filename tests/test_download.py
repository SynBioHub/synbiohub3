...
class TestDownload(TestCase):
    ...
    def test_download(self):
        ...
        compare_get_request_download("/user/:userId/:collectionId/:displayId/:version/sbol", route_parameters = ["testuser", submit_collection_id, "BBa_I0462", "1"], headers = headers)
        compare_get_request_download("/user/:userId/:collectionId/:displayId/:version/sbolnr", route_parameters = ["testuser", submit_collection_id, "BBa_I0462", "1"], headers = headers)
        ...
        compare_get_request_download("/user/:userId/:collectionId/:displayId/:version/gff", route_parameters = ["testuser", submit_collection_id, "BBa_I0462", "1"], headers = headers)
        compare_get_request_download("/user/:userId/:collectionId/:displayId/:version/fasta", route_parameters = ["testuser", submit_collection_id, "BBa_I0462", "1"], headers = headers)
        compare_get_request_download("/user/:userId/:collectionId/:displayId/:version/gb", route_parameters = ["testuser", submit_collection_id, "BBa_I0462", "1"], headers = headers)
