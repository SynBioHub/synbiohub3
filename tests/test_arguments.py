...
parser.add_argument("--sbh1serveraddress",
                    help="specify the synbiohub server to test.",
                    default = "http://localhost:7777/")

parser.add_argument("--sbh3serveraddress",
                    help="specify the synbiohub server to test.",
...
if args.sbh1serveraddress[-1] != '/':
    args.sbh1serveraddress = args.sbh1serveraddress + '/'

# format it with a slash if the slash is missing
if args.sbh3serveraddress[-1] != '/':
    args.sbh3serveraddress = args.sbh3serveraddress + '/'
