...
public interface InstanceMapper {
    ...
    @Mapping(target = "configuration.triplestore.defaultGraph", defaultValue = "http://localhost:8890/sparql")
    @Mapping(target = "configuration.triplestore.sparqlEndpoint", defaultValue = "http://localhost:8890/sparql")
    @Mapping(target = "configuration.triplestore.graphStoreEndpoint", defaultValue = "http://localhost:8890/sparql-graph-crud-auth/")
    ...
    @Mapping(source = "allowPublicSignup", target = "configuration.allowPublicSignup")
    @Mapping(target = "configuration.port", defaultValue = "6789")
    Instance toInstanceEntity(MigrationInstanceRequest request);
